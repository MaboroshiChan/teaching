...
/**
  ...
  */
   ...
   // Scanner and Instance Variables
      ...
      PentagonalPyramid uu = listArray[2]; // statement
      for(PentagonalPyramid pp : listArray){
         pp.getBaseEdge();
         pp.toString();
      }

      ArrayList<PentagonalPyramid> listArray2 = new ArrayList<>(100);
      listArray2.get(2); //statement
